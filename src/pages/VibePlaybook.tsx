...
export default function VibePlaybook() {
  ...
  return (
    <div className="aisb legacy scroll-smooth">
      ...
      {/* Sticky Tab Bar */}
      <div className="sticky top-[64px] md:top-[80px] z-40 bg-[#f7f3ec]/95 backdrop-blur-md border-b border-forest-green/8 px-6 py-3">
